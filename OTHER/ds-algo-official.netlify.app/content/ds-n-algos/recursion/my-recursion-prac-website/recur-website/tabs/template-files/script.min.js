jQuery(t => {
  ...
  t(window)
    .on(o.SCROLL_DATA_API + " " + o.RESIZE_DATA_API, t => {
      clearTimeout(r),
        (r = setTimeout(() => {
          e(t);
        }, 10));
    ...
    t(document)
      ...
      .on(o.COLLAPSE_SHOW + " " + o.COLLAPSE_HIDE, e => {
        t(e.target)
          .closest(h.BASE)
          .each(function () {
            "show" == e.type
  ...
  const e = "navDropdown",
        ...
        c = (() => {
          function e(e, r) {
            ...
            for (let n = 0; n < e.length; n++) this[n] = e[n];
          }
  ...
  (d.prototype.toggle = function (e) {
    ...
    const r = t(this.parentNode), n = r.hasClass(p.OPEN), s = d._isCollapsed(t(this).closest(l.BASE));
    if (
      (d._clearMenus(
        t.Event("click", {
          target: this,
    ...
    (d._dataApiKeydownHandler = function (e) {
      if (!/input|textarea/i.test(e.target.tagName)) {
        let r;
        for (const n in a) if ((r = a[n] === e.which)) break;
        if (r) {
    ...
    (d._dataApiResizeHandler = () => {
      t(l.BASE).each(function () {
        const e = d._isCollapsed(this);
        t(this).find(l.DROPDOWN).removeClass(p.OPEN),
          t(this)
            .find('[aria-expanded="true"]')
            .attr("aria-expanded", "false");
        const r = t(l.BACKDROP)[0];
    ...
    t(document)
      ...
      .on(o.CLICK_DATA_API, l.FORM_CHILD, t => {
        t.stopPropagation();
      }),
