...
((e, t) => {
  ...
  function n(e) {
    ...
    const i = t(e), r = i.overflow, p = i.overflowX, s = i.overflowY;
    return /(auto|scroll)/.test(r + s + p) ? e : n(o(e));
  }

  function r(e) {
    const o = e && e.offsetParent, i = o && o.nodeName;
  ...
  function d(e, t) {
    ...
    const o = e.compareDocumentPosition(t) & Node.DOCUMENT_POSITION_FOLLOWING, i = o ? e : t, n = o ? t : e, a = document.createRange();
  ...
  function a(e) {
    const t =
          ...
          i = e.nodeName;
    if ("BODY" === i || "HTML" === i) {
      const n = window.document.documentElement, r = window.document.scrollingElement || n;
      return r[o];
    }
    return e[o];
  }
  ...
  function f(e, t) {
    const o = 2 < arguments.length && void 0 !== arguments[2] && arguments[2], i = a(t, "top"), n = a(t, "left"), r = o ? -1 : 1;
    return (
      (e.top += i * r),
      (e.bottom += i * r),
      (e.left += n * r),
  ...
  function l(e, t) {
    const o = "x" === t ? "Left" : "Top", i = "Left" == o ? "Right" : "Bottom";
    return (
  ...
  function h() {
    const e = window.document.body, t = window.document.documentElement, o = ie() && window.getComputedStyle(t);
    return {
  ...
  function u(e, o) {
    ...
    if (((h.marginTop = 0), (h.marginLeft = 0), !i && r)) {
      const u = +a.marginTop.split("px")[0], b = +a.marginLeft.split("px")[0];
      (h.top -= l - u),
        (h.bottom -= l - u),
        (h.left -= m - b),
        (h.right -= m - b),
  ...
  function w(e, t, i, r) {
    ...
    if ("viewport" === r) p = b(s);
      ...
      if ("HTML" === a.nodeName && !y(s)) {
        const l = h(), m = l.height, c = l.width;
  ...
  function H(e, t, o, i) {
    const r = "BODY" === e.nodeName, p = r ? window : e;
  ...
  function K(e) {
    const t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1], o = ae.indexOf(e), i = ae.slice(o + 1).concat(ae.slice(0, o));
    return t ? i.reverse() : i;
  }

  function q(e, t, o, i) {
    const n = e.match(/((?:\-|\+)?\d*\.?\d*)(.*)/), r = +n[1], p = n[2];
    if (!r) return e;
    if (0 === p.indexOf("%")) {
      let s;
      switch (p) {
  ...
  var se =
    Object.assign ||
    function (e) {
      for (let t, o = 1; o < arguments.length; o++)
  ...
  (le.Defaults = {
    ...
    modifiers: {
      shift: {
        ...
        enabled: !0,
        fn(e) {
          const t = e.placement, o = t.split("-")[0], i = t.split("-")[1];
          if (i) {
            const n = e.offsets,
                  r = n.reference,
                  p = n.popper,
      ...
      keepTogether: {
        ...
        enabled: !0,
        fn(e) {
          const t = e.offsets, o = t.popper, i = t.reference, n = e.placement.split("-")[0], r = V, p = -1 !== ["top", "bottom"].indexOf(n), s = p ? "right" : "bottom", d = p ? "left" : "top", a = p ? "width" : "height";
          return (
      ...
      arrow: {
        ...
        fn(e, t) {
          ...
          const i = e.placement.split("-")[0], n = e.offsets, r = n.popper, p = n.reference, s = -1 !== ["left", "right"].indexOf(i), d = s ? "height" : "width", a = s ? "top" : "left", f = s ? "left" : "top", l = s ? "bottom" : "right", m = O(o)[d];
      ...
      inner: {
        ...
        enabled: !1,
        fn(e) {
          const t = e.placement, o = t.split("-")[0], i = e.offsets, n = i.popper, r = i.reference, p = -1 !== ["left", "right"].indexOf(o), s = -1 === ["top", "left"].indexOf(o);
          return (
            (n[p ? "left" : "top"] =
      ...
      computeStyle: {
        ...
        fn(e, t) {
          ...
          if (
            ...
            const y = "bottom" == c ? -1 : 1, w = "right" == u ? -1 : 1;
