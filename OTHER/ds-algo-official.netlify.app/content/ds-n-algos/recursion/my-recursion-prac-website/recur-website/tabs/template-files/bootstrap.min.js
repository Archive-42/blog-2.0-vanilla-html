  ...
  const i =
              ...
              typeCheckConfig(t, i, o) {
                for (const r in o)
                  if (o.hasOwnProperty(r)) {
                    const s = o[r], a = i[r], l = a && n(a) ? "element" : e(a);
        ...
        s =
                ...
                _ = (() => {
                  ...
                  (l.prototype._addEventListeners = function () {
                    ...
                    this._config.keyboard &&
                      t(this._element).on(d.KEYDOWN, t => {
                        return e._keydown(t);
                      }),
                  ...
                  (l.prototype._getItemByDirection = function (t, e) {
                    const n = t === u.NEXT, i = t === u.PREV, o = this._getItemIndex(e), r = this._items.length - 1;
                  ...
                  (l._dataApiClickHandler = function (e) {
                    ...
                    if (n) {
                      ...
                      if (i && t(i).hasClass(f.CAROUSEL)) {
                        const o = t.extend({}, t(i).data(), t(this).data()), a = this.getAttribute("data-slide-to");
                        a && (o.interval = !1),
                ...
                p = (() => {
                  function a(e, i) {
                    ...
                    for (let o = t(f.DATA_TOGGLE), s = 0; s < o.length; s++) {
                      const l = o[s], h = r.getSelectorFromElement(l);
                      null !== h &&
                      ...
                      if (
                        ...
                        if (
                          ...
                          for (let o = 0; o < this._triggerArray.length; o++) {
                            const s = this._triggerArray[o], a = r.getSelectorFromElement(s);
                            null !== a &&
                              (t(a).hasClass(u.SHOW) ||
                                t(s)
          ...
          t(document).on(c.CLICK_DATA_API, f.DATA_TOGGLE, function (e) {
            ...
            const n = t(this), i = r.getSelectorFromElement(this);
            t(i).each(function () {
              const e = t(this), i = e.data(s) ? "toggle" : n.data();
                ...
                g = (() => {
                  ...
                  return (l.prototype.toggle = function () {
                    if (
                      ...
                      const e = l._getParentFromElement(this._element), n = t(this._menu).hasClass(u.SHOW);
                      if ((l._clearMenus(), !n)) {
                        const i = {
                  ...
                  (l._dataApiKeydownHandler = function (e) {
                    if (
                      ...
                      const n = l._getParentFromElement(this), i = t(n).hasClass(u.SHOW);
                      if (
          ...
          const e = "modal",
                ...
                f = (() => {
                  ...
                  (a.prototype._showBackdrop = function (e) {
                    const n = this, i = t(this._element).hasClass(u.FADE) ? u.FADE : "";
                  ...
                  (a.prototype._setScrollbar = function () {
                    ...
                    if (this._isBodyOverflowing) {
                      t(d.FIXED_CONTENT).each((n, i) => {
                        const o = t(i)[0].style.paddingRight, r = t(i).css("padding-right");
                        t(i)
                        ...
                        t(d.NAVBAR_TOGGLER).each((n, i) => {
                          const o = t(i)[0].style.marginRight, r = t(i).css("margin-right");
                          t(i)
                            .data("margin-right", o)
                            .css(
                              "margin-right",
                      ...
                      const n = document.body.style.paddingRight, i = t("body").css("padding-right");
                      t("body")
                ...
                f = (() => {
                  function s(e, i) {
                    ...
                    n(this, s),
                      ...
                      t(this._scrollElement).on(h.SCROLL, t => {
                        return o._process(t);
                      }),
                      this.refresh(),
                      this._process();
                  ...
                  (s._jQueryInterface = function (e) {
                    return this.each(function () {
                      ...
                      const o = "object" === (void 0 === e ? "undefined" : i(e)) && e;
                      if (
                        (n ||
                ...
                m = (() => {
                  ...
                  (a.prototype.show = function () {
                    ...
                    if (this.isWithContent() && this._isEnabled) {
                      ...
                      const o = this.getTipElement(), s = r.getUID(this.constructor.NAME);
                      o.setAttribute("id", s),
                  ...
                  (a.prototype._setListeners = function () {
                    ...
                    this.config.trigger.split(" ").forEach(n => {
                      if ("click" === n)
                        ...
                        t(e.element)
                          .on(i, e.config.selector, t => {
                            return e._enter(t);
                          })
                          .on(o, e.config.selector, t => {
                            return e._leave(t);
                          });
                      }
                      t(e.element)
                  ...
                  (a.prototype._cleanTipClass = function () {
                    const e = t(this.getTipElement()), n = e.attr("class").match(l);
                  ...
                  (a.prototype._fixTransition = function () {
                    const e = this.getTipElement(), n = this.config.animation;
    ...
    const a = "popover",
          ...
          g = (s => {
            ...
            (h.prototype._cleanTipClass = function () {
              const t = r(this.getTipElement()), e = t.attr("class").match(c);
