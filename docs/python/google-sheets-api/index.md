...
-   Change the URL in the SCOPE list in the quickstart script to *<a href="https://www.googleapis.com/auth/spreadsheets" class="uri">https://www.googleapis.com/auth/spreadsheets</a>* to make sure that you have both read and write access.
