...
def beg(target*function): <span class="citation" data-cites="wraps">@wraps</span>(target*function) def wrapper(\*args, \**kwargs): msg, say*please = target*function(*args, \*\*kwargs) if say_please: return “{} {}”.format(msg, “Please! I am poor :(”) return msg
