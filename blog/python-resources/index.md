...
If installing using pip install –user, you must add the user-level bin directory to your PATH environment variable in order to launch jupyter lab. If you are using a Unix derivative (FreeBSD, GNU / Linux, OS X), you can achieve this by using export PATH=“<span class="math inline">*HOME*/.\_local\_/*bin*:</span>PATH” command.
...
<a href="https://repl.it/@bgoonz/second-scr?lite=true&amp;referrer=https%3A%2F%2Fbryanguner.medium.com" class="uri">https://repl.it/<span class="citation" data-cites="bgoonz/second-scr?lite">@bgoonz/second-scr?lite</span>=true&amp;referrer=https%3A%2F%2Fbryanguner.medium.com</a>
