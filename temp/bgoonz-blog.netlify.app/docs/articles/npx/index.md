...
2.  you can run different versions of the same command, using the syntax <span class="citation" data-cites="version"><span class="citation" data-cites="version">@version</span></span>
